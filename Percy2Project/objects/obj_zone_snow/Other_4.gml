...
pe_snow_start = part_emitter_create(ps_snow);
pt_snow = part_type_create()

part_emitter_region(ps_snow, pe_snow, bbox_left, bbox_right+(room_height/2), bbox_top-8, bbox_top-8, ps_shape_rectangle, ps_distr_linear);
part_emitter_region(ps_snow, pe_snow_start, bbox_left, bbox_right, bbox_top-8, bbox_bottom, ps_shape_rectangle, ps_distr_linear);
